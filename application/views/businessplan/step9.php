    ...
    <div class="tool-content">
        ...
        <ng-form name="stepsForm" class="ng-pristine ng-invalid ng-invalid-required">
            ...
            <ui-view class="ng-scope">
                <div class="row ml-100 ng-scope">
                    ...
                    <div class="tool-step">Step #9</div>
                    <div class="tool-title">Are You Going To Want Some Additional Help?</div>
                            ...
                            <div class="panel panel-default products" style = "border: 2px solid #c4c3c7;">
                                ...
                                <div class="panel-body">
                                    ...
                                    <?php 
                                        ...
                                        $product_data = $this->businessplans->getProductAdditional($business_plan_id);
                                        //print_r($product_data);//die();

                                    ?>
                                    <?php echo form_open_multipart('businessplan/step10/'.$business_plan_id,array('class' => 'ng-pristine ng-valid','id'=>'step1')); ?> 
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10">
                                                <label class="label-radio inline paddgin-right">
                                                    <input type="radio" required="" name="s9_outsourcing" value="yes" <?php if($product_data[0]->s9_outsourcing=='yes'){echo "checked";} ?>>
                                                        <span class="custom-radio"></span>
                                                        Yes
                                                </label>
                                                <label class="label-radio inline">
                                                    <input type="radio" required="" name="s9_outsourcing" value="no" <?php if($product_data[0]->s9_outsourcing=='no'){echo "checked";} ?>>
                                                        <span class="custom-radio"></span>
                                                        No
                                                </label>
                                            </div><!-- /.col -->
                            ...
                            <div class="panel panel-default products" style = "border: 2px solid #c4c3c7; ">
                                ...
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10">
                                            <label class="label-radio inline paddgin-right">
                                                <input type="radio" required="" name="s9_interview" value="yes" <?php if($product_data[0]->s9_interview=='yes'){echo "checked";} ?>>
                                                    <span class="custom-radio"></span>
                                                    Yes
                                            </label>
                                            <label class="label-radio inline">
                                                <input type="radio" required="" name="s9_interview" value="no" <?php if($product_data[0]->s9_interview=='no'){echo "checked";} ?>>
                                                    <span class="custom-radio"></span>
                                                    No
                                            </label>
                                            <div class="seperator"></div>
        ...
        <div class="row ml-100 mr-100 mt-25">
            <div class="col-md-12 text-center">
                <a class="btn btn-primary" href="<?php echo  base_url()."businessplan/step82/".$business_plan_id ?>">Back</a>
