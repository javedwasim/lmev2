            ...
            <ui-view class="ng-scope">
                <div class="row ml-100 ng-scope">
                    <div class="step-content">                        
                        ...
                        <div class="tool-title">Your Upsells #4</div>
                    </div>
                        ...
                        <div class="col-md-10" >
                            <div class="panel panel-default products" style = "border: 2px solid #c4c3c7;">                                <div class="panel-body">
                                    ...
                                    <?php 
                                        ...
                                        $product_data = $this->businessplans->getProductUpsell($business_plan_id,"step11c");
                                        
                                        $checknextstep = $this->businessplans->getProductUpsell($business_plan_id,"step11d");
                                    ...
                                    <input name="step11upsellno" required="" type="hidden" value="step11c" >
                                    <input name="s11_has_upsell" required="" type="hidden" value="1" >
                                    
                                    <div class="content-action" id="upsell1">
                                        <h1 class="business-form-heading">Upsell #4</h1> 
                                        <div class="separator"></div>
                                        <div class="seperator"></div>
                                        <div class="form-group" data-validated-as="products.0.url">
                                            <input type="text"  name="s11_upsell_prod_name" required="" id="s11_upsell_prod_name" value="<?php if(isset($product_data[0]->s11_upsell_prod_name)){echo $product_data[0]->s11_upsell_prod_name;} ?>" class="form-control input-lg clearvalue" placeholder="Enter Upsell #4 Product Name Here">
                                        </div>
                                        <div class="form-group input-group" data-validated-as="products.0.url">
                                            <span class="input-group-addon">$</span><input type="text" name="s11_upsell_price" required="" id="s11_upsell_price" value="<?php if(isset($product_data[0]->s11_upsell_price)){echo $product_data[0]->s11_upsell_price;} ?>" class="form-control input-lg clearvalue" placeholder="Enter Upsell #4 Price">
                                        </div>
                                        <div class="form-group" data-validated-as="products.0.url">
                                            <textarea class="form-control clearvalue"  name="s11_upsell_detail" required="" id="s11_upsell_detail" rows="3" placeholder="What is the main hook? Why should they buy this upsell #4"><?php if(isset($product_data[0]->s11_upsell_detail)) {echo $product_data[0]->s11_upsell_detail;} ?></textarea>
                                        </div>
                            ...
                            <div class="panel panel-default products" style = "border: 2px solid #c4c3c7;" id="maindownsell" >
                                <div class="panel-body">
                                    ...
                                    <div class="content-action" id="downsell1" style="<?php if(isset($product_data[0]->s11_has_downsell)&& ($product_data[0]->s11_has_downsell==0) || !isset($product_data[0]->s11_has_downsell)){echo 'display:none';}?>">
                                        <h1 class="business-form-heading">Downsell #4</h1> 
                                        <div class="separator"></div>
                                        <div class="seperator"></div>
                                        <div class="form-group" data-validated-as="products.0.url">
                                            <input type="text"  name="s11_downsell_prod_name" id="s11_downsell_prod_name" value="<?php if(isset($product_data[0]->s11_downsell_prod_name)){echo $product_data[0]->s11_downsell_prod_name; }?>" class="form-control input-lg clearvalue" placeholder="Enter Downsell #4 Product Name Here">
                                        </div>
                                        <div class="form-group input-group" data-validated-as="products.0.url">
                                            <span class="input-group-addon">$</span><input type="text"  name="s11_downsell_price" id="s11_downsell_price" value="<?php if(isset($product_data[0]->s11_downsell_price)){echo $product_data[0]->s11_downsell_price;} ?>" class="form-control input-lg clearvalue" placeholder="Enter Downsell #4 Price">
                                        </div>
                                        <div class="form-group" data-validated-as="products.0.url">
                                            <textarea class="form-control clearvalue"  name="s11_downsell_detail" id="s11_downsell_detail" rows="3" placeholder="What is the main hook? Why should they buy this downsell #4"><?php if(isset($product_data[0]->s11_downsell_detail)){echo $product_data[0]->s11_downsell_detail;} ?></textarea>
                                        </div>
                ...
                <div class="row ml-100 mr-100 mt-25">
                    <div class="col-md-12 text-center">
                        <a class="btn btn-primary" href="<?php echo  base_url()."businessplan/step11b/".$business_plan_id ?>">Back</a>
<!--                        <input type="submit" id="submitButton"  name="submitButton" value="Save&Continue" class="btn btn-primary">   -->
                        <?php if(isset($checknextstep[0]) && !empty($checknextstep[0])){ ?>
                            <input type='submit' value='Save Changes' id="step11d" name="step11d" class="btn btn-primary" onclick='this.form.action="<?php echo base_url()."businessplan/step11d/".$business_plan_id; ?>";' />
                        <?php }else{ ?>
                        ...
                        <a class="btn btn-danger" style="margin-left:50px;" href="<?php echo  base_url()."businessplan/deletupsell/step11c/".$business_plan_id ?>">Delete Upsell</a>
                        <?php endif; ?>
                    </div>
                </div>
                 <div class="seperator"></div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <input type='submit' value='Yes' id="step11d" name="step11d" class="btn btn-primary" onclick='this.form.action="<?php echo base_url()."businessplan/step11d/".$business_plan_id; ?>";' />
