    ...
    <div class="tool-content">
        ...
        <ng-form name="stepsForm" class="ng-pristine ng-invalid ng-invalid-required">
            ...
            <ui-view class="ng-scope">
                <div class="row ml-100 ng-scope">
                    ...
                    <div class="tool-step">Step #17</div>
                ...
                <div class="row ml-100 mr-100 ng-scope set-form-margin">
                    <div class="col-md-10 col-lg-offset-1 step-form">
                        <div class="content-action">
                            <h1 class="business-form-heading">How are you going to sell your product?</h1>  
                            <div class="seperator"></div>
                            <div class="seperator"></div>
                            <div class="separator"></div>
                                ...
                                <?php 
                                    ...
                                    $product_data = $this->businessplans->getProductSaleType($business_plan_id);
                                    //print_r($product_data);//die();
                                    
                                ?>
                                <?php echo form_open_multipart('businessplan/step18/'.$business_plan_id,array('class' => 'ng-pristine ng-valid','id'=>'step1')); ?>  
                                 <input name="bp_id" required="" type="hidden" value="<?php echo $business_plan_id; ?>" >
                                 <div class="col-lg-10" style="text-align: center;">
                                    <label class="label-radio inline">
                                        <input type="radio" required="" name="s17_product_type" value="sales-pages" <?php if($product_data[0]->s17_product_type == 'sales-pages'){echo "checked";} ?>>
                                            <span class="custom-radio"></span>
                                            Written Sales Pages
                                    </label>
                                    <label class="label-radio inline">
                                        <input type="radio" required="" name="s17_product_type" value="video" <?php if($product_data[0]->s17_product_type == 'video'){echo "checked";} ?>>
                                            <span class="custom-radio"></span>
                                            Video
                                    </label>
                                     <label class="label-radio inline">
                                         <input type="radio" required="" name="s17_product_type"  value="webinar" <?php if($product_data[0]->s17_product_type == 'webinar'){echo "checked";} ?>>
                                            <span class="custom-radio"></span>
                                            Webinar
                                    </label>
                                </div>
        ...
        <div class="row ml-100 mr-100 mt-25">
            <div class="col-md-12 text-center">
                <a class="btn btn-primary" href="<?php echo  base_url()."businessplan/step16/".$business_plan_id ?>">Back</a> 
