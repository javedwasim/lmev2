function jsUpdateCart(){
  ...
  var ajax = new Ajax.Updater(
    'ajax_msg','/codeigniter/index.php/welcome/ajax_cart', {method:'post',parameters:params,onComplete:showMessage}
    );
...
function jsRemoveProduct(id){
  var params = 'id='+id;
  var ajax = new Ajax.Updater(
    'ajax_msg','/codeigniter/index.php/welcome/ajax_cart_remove', {method:'post',parameters:params,onComplete:showMessage}
    );
